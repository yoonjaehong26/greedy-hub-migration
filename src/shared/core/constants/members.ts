...
export const MEMBERS: Member[] = [
  ...
  //   (노션 데모데이 명부엔 있었으나, 실제 그리디 소속이 아니었음.)
  ...
  // ── 1기 따라행 · 백엔드 (신지훈은 아래 2기 항목에 1기 이력 포함) ──
  // 남해윤: 2기 줍줍 데모팀 명단에도 있으나 미션 수행은 전부 1기 창 → 1기 전담
  { login: 'haeyoon1', name: '남해윤', memberships: [{ cohort: 1, track: 'BE', role: 'B', team: '따라행' }] },
  ...
  // 정창우: 노션 명부엔 1기 모꼬지로도 기재되어 있었으나, 실데이터상 미션 PR은 전부 2기 창(2025-03~07)에만 존재 → 2기 전담으로 정정(1기 이력 제거)
  {
    login: 'ChangwooJ',
    name: '정창우',
    memberships: [{ cohort: 2, track: 'FE', role: 'F', team: '슬종생' }],
  },
  // 신지훈: cross-cohort — 1기 백엔드(따라행) → 2기 프론트(슬종생), 트랙 전환
  {
    login: 'developowl',
    name: '신지훈',
    memberships: [
  ...
  // ── 2기 줍줍 · 프론트 (강동현 mintcoke123은 아래 3기 항목에 2기 FE 이력 포함) ──
  ...
  // 심혁: GitHub login 대소문자 주의(johncakes). todo-list PR 미머지 이력 있음
  {
    login: 'Johncakes',
    name: '심혁',
  ...
  // ── 3기 두구두구 · 백엔드 ──
  // 강동현: cross-cohort — 2기 프론트 → 3기 백엔드. 2기 FE PR은 날짜창으로 자동 분리
  {
    login: 'mintcoke123',
    name: '강동현',
    memberships: [
  ...
  // 이고은: 이름 확정(기념비 기준)
  { login: 'ke-62', name: '이고은', memberships: [{ cohort: 3, track: 'BE', role: 'B', team: '두구두구' }] },
  // ── 3기 밋링크 · 백엔드 ──
  { login: 'chemistryx', name: '하수한', memberships: [{ cohort: 3, track: 'BE', role: 'B', team: '밋링크' }] },
  // 서현진: 방탈출 PR 미머지 이력 있음
  { login: 'nonactress', name: '서현진', memberships: [{ cohort: 3, track: 'BE', role: 'B', team: '밋링크' }] },
  { login: 'kimsky247-coder', name: '김하늘', memberships: [{ cohort: 3, track: 'BE', role: 'B', team: '밋링크' }] },

  // ── 4기(2026-1) 두구두구 · 프론트 (진행 중) ──
  ...
  // ── 4기 백엔드 (진행 중, 1~3기와 동일 5개 nextstep 레포 사용) ──
